package com.hollowmaze.game.controller.trap
...
class Trap(context: Context, position: Position, size: Size) : Object(position, size) {
    private val originalBitmap: Bitmap
    private val scaleFactor = 0.25// Faktor, um das Bitmap um den Faktor 10 zu verkleinern

    var scaledBitmap : Bitmap
    init {
        originalBitmap = BitmapFactory.decodeResource(context.resources, R.drawable.trap)
